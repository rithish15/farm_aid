...
function fetchfarms_dummy(user_key){
    ...
    for(let i = 0;i < FarmArray.length;i++){
        ...
        formoption = "<ul class='nav nav-treeview'><li class='nav-item'><div id='"+FarmArray[i]["farmid"]+"' onclick='myfarms_id(this);' class='nav-link'><i class='fas fa-leaf nav-icon'></i><p>"+FarmArray[i]["farmname"]+"</p></div></li></ul>";
        $('#user_farms').append(formoption);
